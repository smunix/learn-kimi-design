...
#set document(
  ...
  keywords: ("system design", "interviews", "distributed systems", "google docs", "real-time collaboration", "google maps", "geospatial", "routing", "traffic", "rate limiting", "api gateway"),
